...
if (isset($_POST['submit'])){
    ...
    $PriceWhere=$PriceWhere ."(sellprice between 200 and 300)or";
        ...
        $sqlWhere=ltrim(  $sqlWhere, "and");
         ...
         $sql="SELECT * FROM products WHERE category= 'men' and  $sqlWhere  group by name,category";
      
        }else{
            $sql="SELECT * FROM products where category='men' group by name,category";
         }
         if (isset( $_POST['search'])){
      
            $sql="SELECT * FROM products WHERE category= 'Men' and products.name like '%".$_POST['search']."%' group by name";
        }
}else{
    $sql="SELECT * FROM products where category='men' group by name,category";
}
...
<form action="" method="post">
    ...
    <div class="container-fluid bg-secondary ">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Men Shop</h1>
