...
{
//add or substraction the quantity 
  if (isset($_POST['mines'])){
      $qte=$_POST['item'];

  if ($qte>1){
      $item_array=$_SESSION["shopping_cart"][$_POST["id_item"]];
     
      $item_array['quantity']=$item_array['quantity']-1;
     $_SESSION["shopping_cart"][$_POST["id_item"]]= $item_array;
    }
        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
					...
					?>
                        <tr>
                            <td class="align-middle"><img src="<?php echo $values["img"]; ?>" alt="" style="width: 50px;"> <?php echo $values["name"]; ?></td>
                            <td class="align-middle">$<?php echo $values['price']; ?></td>
                            <td class="align-middle">
                            <form action="" method="post">     
       <button class="btn btn-sm btn-primary" name='plus'>+</button>
       <input type='hidden'  name='id_item' value='<?php echo $keys; ?>'/>
       <input type='text' size='1' name='item' value='<?php echo $values["quantity"]; ?>' readonly/>
       <button class="btn btn-sm btn-primary" name='mines'>-</button>
                            </form>
                            </td>
                            <td class="align-middle">$<?php echo $values['price'] * $values["quantity"]; ?></td>
                            <td class="align-middle"><a  class="btn btn-sm btn-primary" href="cart.php?act=delete&id=<?php echo $keys; ?>">X</a></td>
                        </tr>
                    <?php    $total=$total+($values['price'] * $values["quantity"]);
                   }
                } ?>
                    </tbody>
                </table>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <button type="submit" name="submit" class="btn btn-block btn-primary my-3 py-3">Proceed To Checkout</button>
                    </div>
