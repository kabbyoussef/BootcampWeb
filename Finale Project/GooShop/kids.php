...
if (isset( $_POST['search'])){
    ...
    $sql="SELECT * FROM products WHERE category= 'kids' and products.name like '%".$_POST['search']."%' group by name";
...
if (isset($_POST['submit'])){
    ...
    $PriceWhere=$PriceWhere ."(sellprice between 200 and 300)or";
        ...
        $sqlWhere=ltrim(  $sqlWhere, "and");
         ...
         $sql="SELECT * FROM products WHERE category= 'kids' and  $sqlWhere  group by name,category";
      
        }else{
            $sql="SELECT * FROM products where category='kids' group by name,category";
         }
         if (isset( $_POST['search'])){
...
<form action="" method="post">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="kids.php" class="nav-item nav-link active">Kids</a>
    ...
    <div class="container-fluid bg-secondary ">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">kids Shop</h1>
